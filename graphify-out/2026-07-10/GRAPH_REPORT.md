...
## Corpus Check
- 134 files · ~149,215 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 788 nodes · 1256 edges · 46 communities (42 shown, 4 thin omitted)
...
- `getEscalasPeriodo()` --calls--> `query()`  [EXTRACTED]
...
### Community 1 - "query"
Cohesion: 0.06
Nodes (48): sendCircular(), CircularesPage(), getCirculares(), getConsorcios(), agregarParametroCCT(), eliminarParametroCCT(), ParametroCCT, ParametrosCCTPage() (+40 more)

### Community 2 - "actions.ts"
Cohesion: 0.06
Nodes (43): calcularLiquidacionesPeriodo(), confirmarLiquidacion(), deleteConceptoAdicionalPeriodo(), EmpleadoForm, EmpleadoRow, getAdicionalRemuneratorio(), getConceptosAdicionalesPeriodo(), getEmpleados() (+35 more)
...
Cohesion: 0.08
Nodes (23): react, CircularesTableClient(), CircularesTableClientProps, CircularRow, columns, ConsorcioRow, ConsorciosTableClient(), ConsorciosTableClientProps (+15 more)

### Community 9 - "server.ts"
Cohesion: 0.12
Nodes (20): @google/generative-ai, ClassificationResult, classifyMessage(), genAI, MessageCategory, pool, query(), queryOne() (+12 more)
...
Cohesion: 0.09
Nodes (21): dependencies, pg, zod, description, devDependencies, tsx, @types/node, @types/pg (+13 more)
...
## Knowledge Gaps
- **331 isolated node(s):** `name`, `version`, `description`, `type`, `server` (+326 more)
...
- **Why does `query()` connect `query` to `format.ts`, `actions.ts`, `layout.tsx`?**
